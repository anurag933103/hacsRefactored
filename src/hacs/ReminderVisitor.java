...
public class ReminderVisitor extends NodeVisitor {
	...
	public void visitAssignment(Assignment assignment) {
		...
		{
			m_Reminder.listUpcoming.add("today is " + today.toString() + " " + assignment.assignName + " Due Date is "
					+ assignment.getDueDateString());
		}
		if (nDueDate < ntoday) {
			// put to the
			m_Reminder.listOverdue.add(assignment.assignName + " Due Date is " + assignment.getDueDateString());
		}
